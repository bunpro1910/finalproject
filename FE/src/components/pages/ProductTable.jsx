...
export default function ProductTable() {
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => {
                        const promises = selected.map(row => ProductService.deleteProduct(row));
    ...
    useEffect(() => {
        ProductService.getProduct().then(x => {
            setProduct(x.data)
                            ...
                            {data && data.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="left"><img src={`/${row.image}`} className='max-w-[200px]' alt="" /></TableCell>
                                        <TableCell align="right"><Link href={`/admin/product/update/${row.id}`} className='bg-blue-400 rounded-md p-2 text-white mr-2'><Edit /></Link></TableCell>
                                    </TableRow>
                                );
                            })}
                        </TableBody>
